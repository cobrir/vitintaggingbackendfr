...
def titledata():
    ...
    response_data = {
        ...
        "MOTD": "<color=#bb29ff>[ WELCOME TO VITIN TAGGERS ]</color>\n <color=#07dde8>METRO 24</color>\n<color=#ffff00>CREATOR/FOUNDER : VITIN</color>\n<color=#969696>CREDITS TO: VITIN</color>\n<color=#ff8800>DISCORD.GG/TGj2tFxs4w</color>\n<color=#000000>CHANGE YOUR NAME FROM GORILLA##### AS IT'S BANNABLE!</color>",
